...
export const ROUTES = [
  ...
  { path: "/pricing", title: "Pricing | Seated Signal", description: "Priced by fleet size, every program on every plan. Fourteen days free on any tier, no card, month to month.", priority: "0.9" },
  { path: "/trial", title: "Free trial | Seated Signal", description: "Two weeks of your drivers talking back. No card, no contract. We set it up, you approve every message.", priority: "0.8" },
