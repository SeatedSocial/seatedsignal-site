  ...
  <div>
    ...
    <Section style={{ paddingTop: 20 }}>
      <div className="ss-pricing-grid" style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 16, marginBottom: 48, alignItems: "stretch" }}>
        ...
        <PricingCard tier="Growth" price="2,997" fleet="126-250 drivers" popular onTrial={() => setPage("trial")} features={["Everything in Mid, plus:", "Full retention risk scoring", "Slack and email alerts", "Weekly reporting"]} />
